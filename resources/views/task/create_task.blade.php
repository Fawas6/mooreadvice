<div class="content-body" style="margin-top: 15vh;">
    ...
    <div class="form_body" style="display: flex; justify-content: center; align-items: center; margin: 0;">
        <form method="post" action="{{ url('create_tasks') }}" style="text-align: center;">
            @csrf
            ...
            <div><button type="submit" style="text-align: center; margin-top: 10px; font-size: 20px;">Create</button></div>
        </form>
    </div>
    @if (session('success'))
